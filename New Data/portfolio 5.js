...
(function (global) {
  ...
  var CSS = [
    ...
    ".bp-source{font-family:'Manrope',system-ui,sans-serif;font-size:13.5px;font-weight:500;",
    "  color:#5d6578;text-align:center;border-top:1px solid rgba(255,255,255,.07);",
    "  padding-top:12px;margin:16px 0 2px;}",
  ...
  function mount(target, opts) {
    ...
    var source = opts.source !== undefined ? opts.source : "Data from Baya's internal simulations";
    if (source) el("p", "bp-source", stage, source);
    ...
    function applyPos() {
      ...
      var count = pi == null ? products.length + " designs" : "/ " + products.length;
      if (REDUCED) {
