...
(function (global) {
  ...
  var STYLE_ID = "baya-radar-styles-light";
  ...
  var CSS = [
    ...
    "  --br-yellow:#ffce00;--br-surface:#f4f4f4;",
    ...
    /* frameless = the host page provides the card chrome, so the root itself must
       never paint its own surface color underneath it */
    ".bradar-root.bradar-frameless{background:transparent;}",
    ...
    "  paint-order:stroke;stroke:#f4f4f4;stroke-width:3px;}",
  ...
  function create(target, userConfig) {
    ...
    var T = DARK ? {
      ...
      spoke: "#e3e8ef",
      nodeFill: "#f4f4f4", nodeStroke: "#9aa2ac",
      markerRing: "#f4f4f4"
    };
