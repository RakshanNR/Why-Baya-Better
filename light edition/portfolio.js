...
(function (global) {
  ...
  var CSS = [
    ...
    "  margin:28px 0 0;padding:28px 0 0;border-top:1px solid #e5e5e7;}",
    ...
    "  font-weight:600;color:#0a0a0b;margin:0 0 4px;}",
    ".bp-stat-sub{font-size:12.5px;font-weight:500;color:rgba(10,10,11,.6);margin:0;}",
